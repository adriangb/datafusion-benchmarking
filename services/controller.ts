          ...
          env: [
            ...
            { name: "BENCHMARK_CONFIG", value: JSON.stringify({
              allowed_users: [
                ...
                "gabotechs", "Jefffrey", "etseidl", "kosiew", "mkleen", "coderfender",
                "Rachelint", "2010YOUY01",
            ...
            { name: "POLL_INTERVAL_SECS", value: "2" },
            { name: "RECONCILE_INTERVAL_SECS", value: "3" },
